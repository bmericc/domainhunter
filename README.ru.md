...
Domain Hunter — проект с открытым исходным кодом, опубликованный **[Bahri Meriç CANLI](https://domainhunter.tr)**, разработчиком программного обеспечения из Турции. Запущенный в 2006 году под именем *domainhunter.org.tr* при поддержке LKD (Ассоциации пользователей Linux) и её почётного председателя Мустафы Акгюля, проект был полностью переписан для PHP 8+ с современным веб-интерфейсом, CLI, поддержкой SMTP и локализацией на 8 языков.
